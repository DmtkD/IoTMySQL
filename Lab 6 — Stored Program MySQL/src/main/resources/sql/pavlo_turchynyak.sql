...
ALTER TABLE city
    ADD CONSTRAINT city_country FOREIGN KEY city_country (country_name)
...
ALTER TABLE establishment_review_of_establishment
    ADD CONSTRAINT establishment_review_of_establishment_establishment FOREIGN KEY establishment_review_of_establishment_establishment (establishment_id)
        REFERENCES establishment (id);


ALTER TABLE establishment_review_of_establishment
    ADD CONSTRAINT establishment_review_of_establishment_review_of_establishment FOREIGN KEY establishment_review_of_establishment_review_of_establishment (review_of_establishment_id)
        REFERENCES review_of_establishment (id);

ALTER TABLE establishment
    ADD CONSTRAINT establishment_street FOREIGN KEY establishment_street (street_id)
        REFERENCES street (id);

ALTER TABLE establishment
    ADD CONSTRAINT establishment_type_of_establishment FOREIGN KEY establishment_type_of_establishment (type_of_establishment_id)
        REFERENCES type_of_establishment (id);

ALTER TABLE establishment
    ADD CONSTRAINT establishment_Information_about_owner FOREIGN KEY establishment_Information_about_owner (Information_about_owner_id)
        REFERENCES Information_about_owner (id);

ALTER TABLE review_of_establishment
    ADD CONSTRAINT review_of_establishment_user_account FOREIGN KEY review_of_establishment_user_account (user_account_nickname)
        REFERENCES user_account (nickname);

ALTER TABLE street
    ADD CONSTRAINT street_city FOREIGN KEY street_city (city_id)
        REFERENCES city (id);

ALTER TABLE user_account
    ADD CONSTRAINT user_account_credential FOREIGN KEY user_account_credential (credential_id)
...
VALUES (1, "324324fdsfdskjtrteihtjrejitre", 'mtk'),
